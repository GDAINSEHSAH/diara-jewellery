...
import { BuilderStyle, styleOptions } from "@/data/builder";

interface Props {
  selected: BuilderStyle | null;
  onSelect: (style: BuilderStyle) => void;
}
    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {styleOptions.map((option) => (
          <button
            key={option.value}
            onClick={() => onSelect(option.value as BuilderStyle)}
